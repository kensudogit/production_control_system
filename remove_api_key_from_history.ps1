# PowerShell script to remove API key from specific commit
# 特定のコミットからAPIキーを削除するスクリプト
...
Write-Host ""
Write-Host "方法1: 該当ファイルを履歴から削除..." -ForegroundColor Cyan
...
if ($LASTEXITCODE -eq 0) {
    ...
    Write-Host ""
    Write-Host "エラーが発生しました。別の方法を試してください。" -ForegroundColor Red
    Write-Host ""
